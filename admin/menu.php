...
if(isset($_GET['page']) && $_GET['page']=='xyz-wpf-filter-add-new' ){
   	ob_start();
}
if(isset($_GET['page']) && $_GET['page']=='xyz-wpf-filter-manage' ){
   	ob_start();
}
...
add_shortcode( 'xyz_wpf_shortcode' , 'xyz_wpf_shortcode_handler' );
