...
if(!$_POST && (isset($_GET['wpf_blink'])&&isset($_GET['wpf_blink'])=='en')){

	if (! isset( $_REQUEST['_wpnonce'] ) || ! wp_verify_nonce( $_REQUEST['_wpnonce'],'wfp-blk')){
		wp_nonce_ays( 'wfp-blk');
		exit;
	} 
	update_option('xyz_credit_link',"wpf");
?>
...
<?php   
if((get_option('xyz_credit_link')=="0")&&(get_option('xyz_wpf_credit_dismiss')=="0")){
?>
